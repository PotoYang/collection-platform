...
public class EhcacheUtils {
    ...
    public static Cache initCache(String cacheName, int maxElementsInMemory,
        ...
        try {
            ...
            if (myCache == null) {
                Cache memoryOnlyCache = new Cache(cacheName,
                        maxElementsInMemory, overflowToDisk, eternal,
    ...
    public static Cache initCache(String cacheName, long timeToLiveSeconds)
            throws Exception {
        return EhcacheUtils.initCache(cacheName, MAXELEMENTSINMEMORY,
    ...
    @SuppressWarnings("deprecation")
    public static boolean modifyCache(String cacheName, long timeToLiveSeconds,
                                      int maxElementsInMemory) throws Exception {
        try {
     ...
     *                          间歇时间
     * @param timeToLiveSeconds 存活时间 秒 未单位
     * @return 真
    ...
    public static boolean setValue(String cacheName, String key, Object value,
        ...
        try {
            ...
            myCache.put(new Element(key, value, ETERNAL, TIMETOIDLESECONDS,
                    timeToLiveSeconds));
            return true;
        } catch (Exception e) {
            throw new Exception("set cache " + cacheName + " failed!!!");
    ...
    public static boolean removeAllElment(String cacheName, String key)
            throws Exception {
        try {
            CacheManager myManager = CacheManager.create();
            Cache myCache = myManager.getCache(cacheName);
    ...
    public static int getcachesizebycacheName(String cacheName) {
        Cache myCache = cacheManager.getCache(cacheName);
//		myCache.clearStatistics();
        return null != myCache ? myCache.getSize() : 0;
    }
