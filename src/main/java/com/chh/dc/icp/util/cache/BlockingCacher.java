...
import com.chh.dc.icp.util.cache.store.Store;
import com.chh.dc.icp.util.cache.store.impl.MemoryLocalDiskStore;
import com.chh.dc.icp.util.cache.store.impl.MemoryMappintDiskStore;
...
public class BlockingCacher extends AbstractCacher {
    ...
    public BlockingCacher(String cacheFileName) {
        this.cacheFileName = cacheFileName;

        String mappingFileCount = "1";//AppContext.getBean("mappingFileCount", String.class);
    ...
    public Element getElement(ElementIndex elementIndex) throws Exception {
        ...
        try {
            ...
            // 对从系列化中读出的DataBlock对象，要调用一下processOnAfterSerialRead方法
            Object elValue = null;
//			if (element != null && ((elValue = element.getElementValue()) != null)) {
//				DataBlock bataBlock = (DataBlock)elValue;
//				bataBlock.processOnAfterSerialRead(this.repository);
//			}
