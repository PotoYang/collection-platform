...
public class TimeUtil {
    ...
    /**
     * 转换时间为字符串格式 MM-dd HH:mm:ss:SSS
     *
     * @param date
     * @return
     */
    public static String getDateString_MMddhhmmssSSS(Date date) {
        SimpleDateFormat f = new SimpleDateFormat("MM-dd HH:mm:ss:SSS");
        String strTime = f.format(date);
        return strTime;
    }
     ...
     *
     * @param date
     * @param beginTime 开始时间：23:40
     * @param endTime   截止时间：00:20
     * @return boolean
     * @throws Exception
     */
...
//		System.out.println(getDateString_MMddhhmmssSSS(new Date()));
//	}
}
