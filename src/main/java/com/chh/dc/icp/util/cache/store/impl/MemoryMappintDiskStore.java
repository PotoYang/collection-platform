package com.chh.dc.icp.util.cache.store.impl;
...
import com.chh.dc.icp.util.IoUtil;
import com.chh.dc.icp.util.cache.Element;
import com.chh.dc.icp.util.cache.store.AbstractStore;
...
public class MemoryMappintDiskStore extends AbstractStore {
    ...
    protected static final long FILE_SIZE_BYTES = 1;//AppContext.getBean("cacheFileSizeMB", Integer.class) * 1024 * 1024;

    protected static final String CACHE_DIR = "";//AppContext.getBean("cacheFileDir", String.class);

    protected static final Logger LOGGER = LoggerFactory.getLogger(MemoryMappintDiskStore.class); // 日志
